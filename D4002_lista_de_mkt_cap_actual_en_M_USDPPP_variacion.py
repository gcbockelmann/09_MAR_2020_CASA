def lista_mkt_cap_actual_en_M_USDPPP_compara(lista2):
    """ lista """
    ...
    for ticker in lista2:
        ...
        mkt_cap_usdppp_fin_de_ano = df.loc["2018-12-28", 'Mkt_Cap_Close_USD_PPP']
        #
        mkt_cap_actual_en_M_USDPPP = mkt_cap_actual_en_M_USDPPP.append({'Ticker': ticker, 'Fecha': ultima_fecha_mkt_cap_en_USDPPP, 'Mkt_Cap_USDPPP': mkt_cap_usdppp, 'Fin_ano': "2018-12-28", 'Mkt_Cap_USDPPP_fin_de_ano': mkt_cap_usdppp_fin_de_ano }, ignore_index=True)   
        #
        #        
        #
        pass
...
lista_mkt_cap_actual_en_M_USDPPP_compara(lista)
print (mkt_cap_actual_en_M_USDPPP)
mkt_cap_actual_en_M_USDPPP['YTD'] = (mkt_cap_actual_en_M_USDPPP['Mkt_Cap_USDPPP'] / mkt_cap_actual_en_M_USDPPP['Mkt_Cap_USDPPP_fin_de_ano'] )-1

mkt_cap_actual_en_M_USDPPP.sort_values(by ='YTD',  ascending=False)
